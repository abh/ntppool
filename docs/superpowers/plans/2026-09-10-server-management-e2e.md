...
- Create API `server/api/auth/server_test_fixture.go`, `server/api/auth/server_test_fixture_integration_test.go`, `sql/server_test_fixtures.sql`, `db/migrations/027_server_test_fixtures.sql`.
